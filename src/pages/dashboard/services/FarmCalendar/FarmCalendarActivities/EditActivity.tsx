...
const ActivityFormComponentMap: { [key: string]: React.FC<any> } = {
    ...
    'GenericActivity': (props) => <ActivityDynamicCRUDActions<GenericActivityModel> {...props} />,
    'Alert': (props) => <ActivityDynamicCRUDActions<GenericAlertModel> {...props} />,
    'GenericObservation': (props) => <ActivityDynamicCRUDActions<GenericObservationModel> {...props} />,
